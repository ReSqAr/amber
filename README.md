...
Set `AMBER_SSH_KNOWN_HOSTS` to use a different file. This applies to both halves
of the connection: amber's own control channel and the `rclone` transfer that
moves the blobs.
